...
```json
{
  "source": "D:\\RAG\\DataParsing\\doc\\complex_rag_parsing_sample_with_sunny_image.pdf",
  "page_number": 1,
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_001.png"
}
```
...
PAGE 1
                         ...
                         SELCTABLE TEXT Complex RAG Parsing Sample - synthetic document
Page 1
...
Need access-safe retrieval
                         ...
                         OCR_TEXT Complex Document for RAG Parsing Tests
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_002.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_003.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_004.png"
}
```
...
ask questions using clause numbers.
                         ...
                         OCR_TEXT 3. Contract Excerpt: Dense Legal Text
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_005.png"
}
```
...
requests must be raised within 7 days; Owner: Customer Support.
                         ...
                         OCR_TEXT 4. Simple Table: Policy Rules
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_006.png"
}
```
...
become incomplete or misleading.
                         ...
                         OCR_TEXT 5. Complex Table: SLA, Escalation, and Credits
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_007.png"
}
```
...
Description of the diagram
                         ...
                         OCR_TEXT 6. Image: RAG Architecture Diagram
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_008.png"
}
```
...
Order must be preserved
                         ...
                         OCR_TEXT 7. Markdown Runbook Excerpt
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_009.png"
}
```
...
Boolean extraction required
                         ...
                         OCR_TEXT 8. Scanned Form and OCR Challenge
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_010.png"
}
```
...
Relationship metadata allows retrieval across related documents without mixing unrelated client data.
                         ...
                         OCR_TEXT 9. Multiple Documents for One Client
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_011.png"
}
```
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_012.png"
}
```
...
companion table.
                         ...
                         OCR_TEXT 11. Analytics Image: Retention Heatmap
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_013.png"
}
```
...
related documents.
                         ...
                         OCR_TEXT 12. Evaluation Dataset
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_014.png"
}
```
...
Bad parsing creates bad chunks. Bad chunks create bad retrieval. Bad retrieval creates bad answers.
                         ...
                         OCR_TEXT 13. Edge Cases for Parsers
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 0,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_015.png"
}
```
...
End of synthetic 15-page parsing test document.
                         ...
                         OCR_TEXT 15. Final Ingestion Checklist
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_016.png"
}
```
...
PAGE 16
                         ...
                         SELCTABLE TEXT Complex RAG Parsing Sample - appended complex tables
Appendix page 1
...
Table 1: Added as complex parsing appendix for table extraction, OCR fallback, and layout-aware RAG testing.
                         ...
                         OCR_TEXT Appendix A: Complex Clause Responsibility Matrix
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_017.png"
}
```
...
Table 2: Added as complex parsing appendix for table extraction, OCR fallback, and layout-aware RAG testing.
                         ...
                         OCR_TEXT Appendix B: Regional Pricing and Usage Add-on Matrix
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_018.png"
}
```
...
Table 3: Added as complex parsing appendix for table extraction, OCR fallback, and layout-aware RAG testing.
                         ...
                         OCR_TEXT Appendix C: Invoice Line Items with Tax Split
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_019.png"
}
```
...
PAGE 19
                         ...
                         SELCTABLE TEXT Complex RAG Parsing Sample - appended visuals and scanned documents
Appendix page 1
...
Added at the end for complex image parsing, OCR fallback, layout-aware extraction, and multimodal RAG testing.
                         ...
                         OCR_TEXT Appendix D: Multimodal Document Processing Flow
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_020.png"
}
```
...
Added at the end for complex image parsing, OCR fallback, layout-aware extraction, and multimodal RAG testing.
                         ...
                         OCR_TEXT Appendix E: Contract Risk Dashboard Image
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_021.png"
}
```
...
Added at the end for complex image parsing, OCR fallback, layout-aware extraction, and multimodal RAG testing.
                         ...
                         OCR_TEXT Appendix F: Data Lineage and Access Boundary
Image
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_022.png"
}
```
...
Added at the end for complex image parsing, OCR fallback, layout-aware extraction, and multimodal RAG testing.
                         ...
                         OCR_TEXT Appendix G: Additional Scanned Invoice for OCR
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_023.png"
}
```
...
Added at the end for complex image parsing, OCR fallback, layout-aware extraction, and multimodal RAG testing.
                         ...
                         OCR_TEXT Appendix H: Additional Scanned Utility Bill for OCR
...
```json
{
  ...
  "content_type": "page_text_plus_ocr",
  "image_count": 1,
  "page_image_path": "D:\\RAG\\DataParsing\\doc\\output\\page_images\\page_024.png"
}
```
...
PAGE 24
                         ...
                         SELCTABLE TEXT Complex RAG Parsing Sample - appended instructor image
Appendix page 6
...
Added at the end for complex image parsing, multimodal RAG testing, caption grounding, and visual-content extraction checks.
                         ...
                         OCR_TEXT Appendix I: Profile Image for Multimodal Parsing
...
TABLE FOUND ON PAGE 1
                      ...
                      TABLE MARKDOWN | Section               | Parsing challenge                       | Why it matters for RAG                  |
|:----------------------|:----------------------------------------|:----------------------------------------|
| Contracts             | Dense legal text, clause numbers, cross | Need section-aware chunks and citations |
|                       | references                              |                                         |
| Tables                | Merged headers, numeric columns,        | Need row/column preservation            |
...
TABLE FOUND ON PAGE 2
                      ...
                      TABLE MARKDOWN | Client            | Main document family        | Risk   | Primary users        | Typical question                    |
|:------------------|:----------------------------|:-------|:---------------------|:------------------------------------|
...
TABLE FOUND ON PAGE 3
                      ...
                      TABLE MARKDOWN | Asset ID     | Client            | Format      | Pages/Rows   | Expected extraction          | Notes                         |
|:-------------|:------------------|:------------|:-------------|:-----------------------------|:------------------------------|
...
TABLE FOUND ON PAGE 4
                      ...
                      TABLE MARKDOWN |   Clause | Short name      | Owner            | Trigger                 | Required action                          | Citation hint   |
|---------:|:----------------|:-----------------|:------------------------|:-----------------------------------------|:----------------|
...
TABLE FOUND ON PAGE 5
                      ...
                      TABLE MARKDOWN | Policy Area       | Rule                                                 | Owner            | Review Cycle        |
|:------------------|:-----------------------------------------------------|:-----------------|:--------------------|
| Refunds           | Refund requests must be raised within 7 days of      | Customer Support | Quarterly           |
|                   | purchase.                                            |                  |                     |
| Data Export       | Client admins can request export in CSV or JSON      | Platform Ops     | Monthly             |
...
TABLE FOUND ON PAGE 6
                      ...
                      TABLE MARKDOWN | Service Category   | Severity       | Response Target   | Resolution Target   | Service Credit         | Evidence Required              |
|:-------------------|:---------------|:------------------|:--------------------|:-----------------------|:-------------------------------|
...
TABLE FOUND ON PAGE 7
                      ...
                      TABLE MARKDOWN | Image element   | Potential extraction method    | Expected output                      |
|:----------------|:-------------------------------|:-------------------------------------|
| Box labels      | OCR or vision model            | Raw Files, Parser, Chunks, Vector DB |
| Arrows          | Layout or vision understanding | Processing order                     |
| Caption         | Normal PDF text extraction     | Description of the diagram           |
...
TABLE FOUND ON PAGE 8
                      ...
                      TABLE MARKDOWN | Runbook field   | Value                      | Parsing expectation                     |
|:----------------|:---------------------------|:----------------------------------------|
| Title           | Contract Ingestion Failure | Should become section title metadata    |
| Symptoms        | Five bullet items          | Should remain as list or separate lines |
| Recovery Steps  | Numbered sequence          | Order must be preserved                 |
...
TABLE FOUND ON PAGE 9
                      ...
                      TABLE MARKDOWN | Field             | Expected OCR value      | Validation rule                      |
|:------------------|:------------------------|:-------------------------------------|
...
TABLE FOUND ON PAGE 10
                      ...
                      TABLE MARKDOWN | document_id   | document_type     | contract_group_id   | effective_date   | relationship                       |
|:--------------|:------------------|:--------------------|:-----------------|:-----------------------------------|
...
TABLE FOUND ON PAGE 11
                      ...
                      TABLE MARKDOWN | Layer               | Control                              | Failure mode if missing                     |
|:--------------------|:-------------------------------------|:--------------------------------------------|
...
TABLE FOUND ON PAGE 12
                      ...
                      TABLE MARKDOWN | Observation                | Supporting value        | Scheduling implication                           |
|:---------------------------|:------------------------|:-------------------------------------------------|
...
TABLE FOUND ON PAGE 13
                      ...
                      TABLE MARKDOWN | Test ID   | Question                        | Expected source    | Expected answer element    | Failure signal      |
|:----------|:--------------------------------|:-------------------|:---------------------------|:--------------------|
...
TABLE FOUND ON PAGE 14
                      ...
                      TABLE MARKDOWN | Edge case              | Example                             | Recommended handling                         |
|:-----------------------|:------------------------------------|:---------------------------------------------|
| Repeated headers and   | Page number, confidentiality banner | Remove or store separately as metadata       |
| footers                |                                     |                                              |
...
TABLE FOUND ON PAGE 15
                      ...
                      TABLE MARKDOWN | Checklist item   | Status to verify                              | Why it matters                       |
|:-----------------|:----------------------------------------------|:-------------------------------------|
| Text extraction  | Paragraphs are readable and ordered           | Prevents noisy chunks                |
| Table extraction | Rows, columns, headers, and footnotes         | Protects factual answers             |
|                  | preserved                                     |                                      |
...
TABLE FOUND ON PAGE 24
                      ...
                      TABLE MARKDOWN | Element        | Parsing Challenge                         | Expected Handling                                    |
|:---------------|:------------------------------------------|:-----------------------------------------------------|
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_002_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 2
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_002_image_1.png

                        IMAGE OCR TEXT: Contract Processing Ownership Map
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_007_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 7
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_007_image_1.png

                        IMAGE OCR TEXT: RAG Ingestion and Retrieval Flow
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_009_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 9
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_009_image_1.png

                        IMAGE OCR TEXT: Client Name:
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_012_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 12
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_012_image_1.png

                        IMAGE OCR TEXT: Viewer Retention Heatmap by Time Slot
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_016_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 16
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_016_image_1.png

                        IMAGE OCR TEXT: ae ennn mr en macnn NSN ON NONE ONS NEE DINE POLE II
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_017_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 17
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_017_image_1.png

                        IMAGE OCR TEXT: Plan ‘Student Volume Annual Platform Charges Usage Add-ons Billing Rule
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_018_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 18
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_018_image_1.png

                        IMAGE OCR TEXT: Line tem
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_019_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 19
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_019_image_1.png

                        IMAGE OCR TEXT: Visual Appendix 1: Multimodal Document Flow
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_020_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 20
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_020_image_1.png

                        IMAGE OCR TEXT: Visual Appendix 2: Contract Risk Dashboard Snapshot
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_021_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 21
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_021_image_1.png

                        IMAGE OCR TEXT: Visual Appendix 3: Data Lineage and Access Boundary
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_022_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 22
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_022_image_1.png

                        IMAGE OCR TEXT: SCANNED TAX INVOICE
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_023_image_1.png",
  "image_ext": "png"
}
```
...
IMAGE FOUND ON PAGE 23
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_023_image_1.png

                        IMAGE OCR TEXT: SCANNED UTILITY BILL
...
```json
{
  ...
  "content_type": "image",
  "image_index": 1,
  "image_path": "D:\\RAG\\DataParsing\\doc\\output\\extracted_images\\page_024_image_1.jpeg",
  "image_ext": "jpeg"
}
```
...
IMAGE FOUND ON PAGE 24
                        ...
                        IMAGE PATH: D:\RAG\DataParsing\doc\output\extracted_images\page_024_image_1.jpeg
